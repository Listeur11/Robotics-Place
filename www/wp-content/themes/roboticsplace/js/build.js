...
var Parallax = function (_Smooth) {
    ...
    _createClass(Parallax, [{
        ...
        value: function run() {
            ...
            this.dom.section.style[this.prefix] = //this.getTransform(this.vars.current * -1); LAISSER COMMENTÉ
        ...
        value: function inViewport(el, index) {
            ...
            var top = Math.round(cache.top + transform - current)-300;
            var bottom = Math.round(cache.bottom + transform - current)+0;
            var inview = bottom > 0 && top < this.vars.height;
            

            if (inview) {

                //el.style.border = '0px solid green';
                //el.style.opacity = '1';
                el.classList.add("vs-show");
                el.classList.remove("vs-hide");
                ...
                //el.style.opacity = '0';
                el.classList.remove("vs-show");
                el.classList.add("vs-hide");
