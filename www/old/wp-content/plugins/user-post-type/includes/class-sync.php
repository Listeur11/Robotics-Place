...
class UPT_Sync
{
     ...
     */
    function run_hooks() {
        add_action( 'user_register',    array( $this, 'run_sync' ) );
        add_action( 'profile_update',   array( $this, 'run_sync' ) );
        add_action( 'delete_user',      array( $this, 'delete_user_post' ) );
        add_action( 'upt_sync_cron',    array( $this, 'get_progress' ) );
    }
